...
static UITableViewCellLayoutManager* kValue1;
...
+ (void) initialize
{
    if (self == [UITableViewCellLayoutManager class]) {
        ...
        dispatch_once(&onceToken, ^{
            ...
            kValue1 = [[UITableViewCellLayoutManagerValue1 alloc] init];
        });
    }
}
...
- (CGSize) _combinedLabelsSizeForCell:(UITableViewCell*)cell
{
    ...
    CGSize combinedSizes = {
        .width = tvSize.width + dvSize.width,
        .height = tvSize.height > dvSize.height ? tvSize.height : dvSize.height
    };
